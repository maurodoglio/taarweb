...
class TaarGoogleOAuth2Adapter(GoogleOAuth2Adapter):
    provider_id = TaarGoogleProvider.id
...
oauth2_login = OAuth2LoginView.adapter_view(TaarGoogleOAuth2Adapter)
oauth2_callback = OAuth2CallbackView.adapter_view(TaarGoogleOAuth2Adapter)
